...
public class MySQLConnection {
        ...
        try {
            ...
            for (String itemId : favoriteItemIds) {
                ...
                if (rs.next()) {
                    ...
                    Item item = new Item.Builder().id(rs.getString("id")).title(rs.getString("title")).url(rs.getString("url")).thumbnailUrl(rs.getString("thumbnail_url"))
    ...
    // Verify if the given user Id and password is correct. Returns the user name when it passes
